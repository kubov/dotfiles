...
for s = 1, screen.count() do
   ...
   tags[s] = awful.tag({ " 1:www", " 2:emacs", " 3:_", " 4:tmux"," 5:irc", " 6:mail", " 7:spotify" }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey, "Shift"   }, "l",     function () os.execute('slimlock')        end),
...
awful.rules.rules = {
   ...
   { rule = { class = "Emacs" },
     properties = { border_color = "#ff0000", border_focus = "#161a1f"} },
   { rule = { class = "Xfce4-terminal"},
     properties = {} },
   -- Set Firefox to always map on tags number 2 of screen 1.
   { rule = { class = "Firefox" },
     properties = { tag = tags[1][1], max = true } },
   { rule = { class = "Thunderbird" },
     properties = { tag = tags[1][6], max = true } },
   { rule = { class = "Spotify" },
     properties = { tag = tags[1][7], max = true } }
}
-- }}}
